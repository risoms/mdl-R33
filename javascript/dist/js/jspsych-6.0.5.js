...
window.jsPsych = (function() {
  ...
  core.init = function(options) {
    ...
    opts.display_element = $("#jspsych-target")

    // set DOM element where jsPsych will render content
    $div = $("<div>", {id: "jspsych-content", "class": "jspsych-content"});
...
jsPsych.pluginAPI = (function() {
  ...
  module.reset = function(root_element){
    keyboard_listeners = [];
    held_keys = {};
    root_element[0].removeEventListener('keydown', root_keydown_listener);
    root_element[0].removeEventListener('keyup', root_keyup_listener);
  }

  module.createKeyboardEventListeners = function(root_element){
    root_element[0].addEventListener('keydown', root_keydown_listener);
    root_element[0].addEventListener('keyup', root_keyup_listener);
  }
