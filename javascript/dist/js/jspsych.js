...
var jsPsych = (function() {
  ...
  core.init = function(options) {
      ...
      if (opts.auto_preload) {
          jsPsych.pluginAPI.autoPreload(timeline,
              startExperiment);
  ...
  core.progress = function() {
      ...
      var percent_complete = typeof timeline ==
          'undefined' ? 0 : timeline.percentComplete();

      var obj = {
          "total_trials": typeof timeline ==
              'undefined' ? undefined : timeline
              .length(),
  ...
  core.totalTime = function() {
      ...
      return (new Date()).getTime() - exp_start_time
          .getTime();
  };
  ...
  core.finishTrial = function(data) {
      ...
      var trial_data = jsPsych.data.getDataByTrialIndex(
          global_trial_index);

      // handle callback at plugin level
      if (typeof current_trial.on_finish ===
          'function') {
      ...
      // wait for iti
      if (typeof current_trial.timing_post_trial ==
          'undefined') {
          ...
          if (current_trial.timing_post_trial > 0) {
              setTimeout(nextTrial, current_trial
                  .timing_post_trial);
          } else {
              nextTrial();
          }
  ...
  function TimelineNode(parameters, parent, relativeID) {
      ...
      var progress = {
          current_location: -
          1, // where on the timeline (which timelinenode)
      ...
      this.markCurrentTrialComplete = function() {
          if (typeof timeline_parameters ==
              ...
              timeline_parameters.timeline[progress
                      .current_location]
      ...
      this.nextRepetiton = function() {
          ...
          for (var i = 0; i < timeline_parameters
              .timeline.length; i++) {
      ...
      this.setTimelineVariablesOrder = function() {
          var order = [];
          for (var i = 0; i < timeline_parameters
              .timeline_variables.length; i++) {
              order.push(i);
          }

          if (timeline_parameters.randomize_order) {
              order = jsPsych.randomization.shuffle(
                  order);
          }
      ...
      this.advance = function() {
          ...
          if (typeof timeline_parameters !==
              ...
              while (progress.current_location <
                  timeline_parameters.timeline.length &&
              ...
              if (progress.current_variable_set <
              ...
              else if (progress.current_repetition <
              ...
              else if (typeof timeline_parameters
                  .loop_function !== 'undefined') {
                  if (timeline_parameters.loop_function(
                          this.generatedData())) {
                      this
                  .reset(); // TODO: fix this probably...
      ...
      this.getTimelineVariableValue = function(
          variable_name) {
          if (typeof timeline_parameters ==
              'undefined') {
              return undefined;
          }
          var v = timeline_parameters
              .timeline_variables[progress.order[
                  progress.current_variable_set]][
                  variable_name
              ];
          return v;
      ...
      this.findTimelineVariable = function(variable_name) {
          var v = this.getTimelineVariableValue(
              variable_name);
          if (typeof v == 'undefined') {
              if (typeof parent_node !== 'undefined') {
                  return parent_node
                      .findTimelineVariable(
                          variable_name);
              } else {
                  return undefined;
              }
      ...
      this.timelineVariable = function(variable_name) {
          if (typeof timeline_parameters ==
              'undefined') {
              return this.findTimelineVariable(
                  variable_name);
          } else {
              return timeline_parameters.timeline[
                      progress.current_location]
      ...
      this.reset = function() {
          ...
          if (typeof timeline_parameters !=
              ...
              for (var i = 0; i < timeline_parameters
                  .timeline.length; i++) {
                  timeline_parameters.timeline[i]
                  .reset();
              }
          }
      ...
      this.generatedData = function() {
          return jsPsych.data.getDataByTimelineNode(this
              .ID());
      }
      ...
      this.trialsOfType = function(type) {
          if (typeof timeline_parameters ==
              ...
              for (var i = 0; i < timeline_parameters
                  .timeline.length; i++) {
                  var t = timeline_parameters.timeline[
                      i].trialsOfType(type);
      ...
      this.insert = function(parameters) {
          if (typeof timeline_parameters ==
              'undefined') {
              console.error(
                  'Cannot add new trials to a trial-level node.'
                  );
          } else {
              timeline_parameters.timeline.push(
                  new TimelineNode($.extend(
                          true, {}, node_trial_data,
                          parameters), self,
                      timeline_parameters.timeline
                      .length)
              );
      ...
      var _construct = function() {
          ...
          if (typeof parameters.timeline !==
              'undefined') {

              // create timeline properties
              timeline_parameters = {
                  timeline: [],
                  loop_function: parameters
                      .loop_function,
                  conditional_function: parameters
                      .conditional_function,
                  randomize_order: typeof parameters
                      .randomize_order ==
                      'undefined' ? false :
                      parameters.randomize_order,
                  repetitions: typeof parameters
                      .repetitions == 'undefined' ?
                      1 : parameters.repetitions,
                  timeline_variables: typeof parameters
                      .timeline_variables ==
                      'undefined' ? [{}] :
              ...
              node_trial_data =
              node_data; // store for later...

              // create a TimelineNode for each element in the timeline
              for (var i = 0; i < parameters.timeline
                  .length; i++) {
                  timeline_parameters.timeline.push(
                      new TimelineNode($.extend(
                          true, {}, node_data,
          ...
          // if there is no timeline parameter, then this node is a trial node
              ...
              } else if (typeof jsPsych.plugins[
                      trial_type] == 'undefined') {
                  console.error(
                      'No plugin loaded for trials of type "' +
                      trial_type + '"');
              }
              // create a deep copy of the parameters for the trial
              trial_parameters = $.extend(true, {},
                  parameters);
          }
  ...
  function startExperiment() {
      ...
      if (fullscreen) {
          ...
          var keyboardNotAllowed = typeof Element !==
              'undefined' && 'ALLOW_KEYBOARD_INPUT' in
              Element;
          if (keyboardNotAllowed) {
              ...
              $('#jspsych-fullscreen-btn').on('click',
                  function() {
  ...
  function doTrial(trial) {
      ...
      jsPsych.plugins[trial.type].trial(display_element,
          trial);
  }

  function loadFail() {
      DOM_target.html(
          '<p>The experiment failed to load.</p>');
  }
...
jsPsych.data = (function() {
  ...
  module.getforServer = function() {
      eye_data = _.clone(
      sample_array); //prepare eye data
      prac_data = jsPsych.data.getTrialsOfType(
          "dotprobe-practice"); //prepare practice data
      behav_data = jsPsych.data.getTrialsOfType(
          "dotprobe-task"); //prepare task data
      merged_data = merge_array(prac_data, behav_data,
          eye_data) //merge data
      return merged_data
  };
  ...
  module.write = function(data_object) {
      ...
      var default_data = {
          ...
          'internal_node_id': jsPsych
              .currentTimelineNodeID()
      };

      var ext_data_object = $.extend({}, data_object,
          trial.data, default_data, dataProperties);
  ...
  module.addProperties = function(properties) {
      ...
      dataProperties = $.extend({}, dataProperties,
          properties);
  };
  ...
  module.localSave = function(filename, format) {
      ...
      if (format == 'JSON' || format == 'json') {
          data_string = JSON.stringify(module
      .getData());
      } else if (format == 'CSV' || format == 'csv') {
          data_string = module.dataAsCSV();
      } else {
          throw new Error(
              'invalid format specified for jsPsych.data.localSave'
              );
      }
  ...
  module.getDataByTimelineNode = function(node_id) {
      ...
      var trials = [];
      for (var i = 0; i < data.length; i++) {
          if (data[i].internal_node_id.slice(0, node_id
                  .length) === node_id) {
              trials.push(data[i]);
          }
      }
  ...
  module.getLastTimelineData = function() {
      ...
      if (typeof node_id === 'undefined') {
          ...
          var parent_node_id = node_id.substr(0, node_id
              .lastIndexOf('-'));
          var lastnodedata = module
              .getDataByTimelineNode(parent_node_id);
          return lastnodedata;
      }
  }
  ...
  module.createInteractionListeners = function() {
      ...
      function fullscreenchange() {
          var type = (document.isFullScreen || document
                  .webkitIsFullScreen || document
                  .mozIsFullScreen) ?
  ...
  function saveTextToFile(textstr, filename) {
      ...
      if (typeof window.webkitURL !== 'undefined') {
          blobURL = window.webkitURL.createObjectURL(
              blobToSave);
      } else {
  ...
  function JSON2CSV(objArray) {
      var array = typeof objArray != 'object' ? JSON.parse(
          objArray) : objArray;
      var line = '';
      var result = '';
      var columns = [];
      ...
      for (var i = 0; i < array.length; i++) {
          ...
          for (var j = 0; j < columns.length; j++) {
              var value = (typeof array[i][columns[j]] ===
                  'undefined') ? '' : array[i][columns[
                  j]];
  ...
  function getQueryString() {
      ...
      for (var i = 0; i < a.length; ++i) {
          ...
          if (p.length == 1)
              ...
              b[p[0]] = decodeURIComponent(p[1].replace(
                  /\+/g, " "));
      }
      return b;
  }
...
jsPsych.turk = (function() {
  ...
  module.turkInfo = function() {
      ...
      var src = param(window.location.href,
              "assignmentId") ? window.location.href :
          document.referrer;
      ...
      turk.previewMode = (turk.assignmentId ==
          "ASSIGNMENT_ID_NOT_AVAILABLE");

      turk.outsideTurk = (!turk.previewMode && turk
          .hitId === "" && turk.assignmentId ==
          "" && turk.workerId == "")
  ...
  module.submitToTurk = function(data) {
      ...
      for (var key in data) {
          ...
          if (data.hasOwnProperty(key)) {
              dataString.push(key + "=" + escape(data[
                  key]));
          }
      }
      ...
      var url = turkSubmitTo +
          "/mturk/externalSubmit?" + dataString.join(
              "&");
...
jsPsych.randomization = (function() {
  ...
  module.repeat = function(array, repetitions, unpack) {
      ...
      for (var i = 0; i < array.length; i++) {
          for (var j = 0; j < repetitions[i]; j++) {
              if (array[i] == null || typeof array[i] !=
                  'object') {
                  allsamples.push(array[i]);
              } else {
                  allsamples.push($.extend(true, {},
                      array[i]));
              }
  ...
  module.shuffleNoRepeats = function(arr, equalityTest) {
      ...
      for (var i = 0; i < random_shuffle.length -
          2; i++) {
          if (equalityTest(random_shuffle[i],
                  random_shuffle[i + 1])) {
              // neighbors are equal, pick a new random neighbor to swap (not the first or last element, to avoid edge cases)
              var random_pick = Math.floor(Math
              .random() * (random_shuffle.length -
                      2)) + 1;
              // test to make sure the new neighbor isn't equal to the old one
              while (
                  equalityTest(random_shuffle[i + 1],
                      random_shuffle[random_pick]) ||
                  (equalityTest(random_shuffle[i + 1],
                      random_shuffle[random_pick +
                          1]) || equalityTest(
                      random_shuffle[i + 1],
                  ...
                  random_pick = Math.floor(Math
                  .random() * (random_shuffle
                          .length - 2)) + 1;
              }
              var new_neighbor = random_shuffle[
                  random_pick];
              random_shuffle[random_pick] =
                  random_shuffle[i + 1];
  ...
  module.sample = function(arr, size, withReplacement) {
      if (withReplacement == false) {
          if (size > arr.length) {
              console.error(
                  "jsPsych.randomization.sample cannot take a sample " +
      ...
      for (var i = 0; i < size; i++) {
          if (!withReplacement) {
              ...
              samp.push(shuff_arr[Math.floor(Math
                  .random() * shuff_arr
                  .length)]);
          }
      }
  ...
  module.factorial = function(factors, repetitions,
  unpack) {
      ...
      for (var i = 0; i < factors[factorNames[0]]
          .length; i++) {
          factor_combinations.push({});
          factor_combinations[i][factorNames[0]] =
              factors[factorNames[0]][i];
      }
      ...
      for (var i = 1; i < factorNames.length; i++) {
          ...
          for (var j = 0; j < n; j++) {
              ...
              for (var k = 0; k < toAdd.length; k++) {
                  ...
                  factor_combinations.push($.extend({},
                      base, newpiece));
              }
          }
      ...
      repetitions = (typeof repetitions ===
          'undefined') ? 1 : repetitions;
      var with_repetitions = module.repeat(
          factor_combinations, repetitions, unpack);
  ...
  module.randomID = function(length) {
      var result = '';
      var length = (typeof length == 'undefined') ? 32 :
          length;
...
jsPsych.pluginAPI = (function() {
  ...
  module.getKeyboardResponse = function(parameters) {
      ...
      parameters.rt_method = (typeof parameters
              .rt_method === 'undefined') ? 'date' :
          parameters.rt_method;
      if (parameters.rt_method != 'date' && parameters
          .rt_method != 'performance' && parameters
          .rt_method != 'audio') {
          console.log(
      ...
      var listener_function = function(e) {
          ...
          if (parameters.rt_method == 'date') {
              ...
              'audio') {
              key_time = parameters.audio_context
                  .currentTime
          }

          var valid_response = false;
          if (typeof parameters.valid_responses ===
              'undefined' || parameters
              .valid_responses == jsPsych.ALL_KEYS
              ) {
              valid_response = true;
          } else {
              if (parameters.valid_responses !=
                  jsPsych.NO_KEYS) {
                  for (var i = 0; i < parameters
                      .valid_responses.length; i++
                      ) {
          ...
          if (((typeof parameters.allow_held_key ==
                      'undefined') || !parameters
                  .allow_held_key) &&
              valid_response) {
              for (i in held_keys) {
          ...
          if (valid_response) {
              ...
              if ($.inArray(listener_id,
                      keyboard_listeners) > -1) {

                  if (!parameters.persist) {
                      // remove keyboard listener
                      module.cancelKeyboardResponse(
                          listener_id);
                  }
              }
  ...
  module.cancelKeyboardResponse = function(listener) {
      ...
      if ($.inArray(listener, keyboard_listeners) > -
          1) {
          keyboard_listeners.splice($.inArray(listener,
              keyboard_listeners), 1);
      }
  };

  module.cancelAllKeyboardResponses = function() {
      for (var i = 0; i < keyboard_listeners
          .length; i++) {
          $(document).off(keyboard_listeners[i].type,
              keyboard_listeners[i].fn);
      }
      keyboard_listeners = [];
  };

  module.convertKeyCharacterToKeyCode = function(
  character) {
      var code;
  ...
  module.evaluateFunctionParameters = function(trial,
      protect) {

      // keys that are always protected
      var always_protected = ['on_finish'];

      protect = (typeof protect === 'undefined') ? [] :
          protect;
  ...
  if (typeof window !== 'undefined' && window
      .hasOwnProperty('webkitAudioContext') && !window
      .hasOwnProperty('AudioContext')) {
      window.AudioContext = webkitAudioContext;
  }
  // end patch

  var context = (typeof window !== 'undefined' &&
  ...
  module.getAudioBuffer = function(audioID) {
      ...
      if (audio_buffers[audioID] == 'tmp') {
          console.error(
              'Audio file failed to load in the time alloted.'
              )
          return;
      }
  ...
  module.preloadAudioFiles = function(files,
      callback_complete, callback_load) {

      files = flatten(files);

      var n_loaded = 0;
      var loadfn = (typeof callback_load ===
              'undefined') ? function() {} :
          callback_load;
      var finishfn = (typeof callback_complete ===
              'undefined') ? function() {} :
          callback_complete;
      ...
      for (var i = 0; i < files.length; i++) {
          ...
          if (typeof audio_buffers[bufferID] !==
              'undefined') {
              n_loaded++;
              loadfn(n_loaded);
  ...
  module.preloadImages = function(images, callback_complete,
      callback_load) {
  ...
  module.registerPreload = function(plugin_name, parameter,
      media_type, conditional_function) {
      if (!(media_type == 'audio' || media_type ==
              'image')) {
          console.error(
  ...
  module.autoPreload = function(timeline, callback) {
      ...
      for (var i = 0; i < preloads.length; i++) {
          ...
          for (var j = 0; j < trials.length; j++) {
              if (typeof trials[j][param] !==
                  'undefined' && typeof trials[j][
                  param] !== 'function') {
